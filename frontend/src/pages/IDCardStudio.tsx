      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden relative">
        ...
        >
          ...
          <div className="flex items-center gap-1.5 md:gap-2 flex-shrink-0">
            {/* Realistic ID Mockup Preview */}
            <button
              onClick={() => setIsMockupModalOpen(true)}
              className="flex items-center gap-1.5 px-2.5 md:px-3 py-1.5 text-[11px] md:text-xs font-bold rounded-xl border transition-all cursor-pointer text-amber-400 border-amber-500/30 hover:border-amber-400"
              style={{ backgroundColor: 'var(--bg-elevated)' }}
              title="Realistic 3D ID Mockup in Context (Lanyard, Desk Stand, Rigid Sleeve)"
            >
