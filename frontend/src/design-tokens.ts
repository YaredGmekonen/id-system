...
export const CARD_SIZE_PRESETS: CardSizePreset[] = [
  ...
  },
  {
    ...
    widthPx: 1063,
    heightPx: 679,
    description: 'User-specified width and height in millimeters (Default saved: 90 × 57.5 mm)',
  },
];

export interface SavedCustomCardSize {
  id: string;
  name: string;
  widthMm: number;
  heightMm: number;
...
export const DEFAULT_SAVED_CUSTOM_SIZES: SavedCustomCardSize[] = [
  {
    id: 'custom-std-90-575',
    name: 'Custom Standard (90.0 × 57.5 mm)',
    widthMm: 90.0,
    heightMm: 57.5,
    isDefault: true,
  },
